...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description: 'A collection of projects demonstrating effective prompt design for various AI applications, based on skills from the Google Cloud "Prompt Design in AI" certification.',
