...
export const CoinIcon: React.FC = () => (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-yellow-800/60">
        <path d="M8 4h8l4 4v8l-4 4H8l-4-4V8l4-4z" />
        <line x1="12" y1="4" x2="12" y2="20" />
    </svg>
);

export const MonkeyTypeIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
       <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zm0 14h16v-2H4v2zM6 8h3v3H6V8zm5 0h2v3h-2V8zm4 0h3v3h-3V8z"/>
    </svg>
);

export const GFGIcon: React.FC = () => (
    <img src="https://cdn.brandfetch.io/idw2s-0Tuo/w/400/h/400/theme/dark/icon.jpeg?c=1dxbfHSJFAPEGdCLU4o5B" alt="GeeksforGeeks" className="w-6 h-6 object-contain" />
);

export const LeetCodeIcon: React.FC = () => (
    <img src="https://i.postimg.cc/bYSPRGyZ/image.png" alt="LeetCode" className="w-6 h-6 object-contain" />
);
