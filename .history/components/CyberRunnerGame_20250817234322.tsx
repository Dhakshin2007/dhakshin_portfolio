...
export const CyberRunnerGame: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const drawUi = (ctx: CanvasRenderingContext2D) => {
            ...
            if (gameState === 'idle') {
                ...
                ctx.fillText('Click, Tap, or Press Space to Start', GAME_WIDTH / 2, GAME_HEIGHT / 2 + 20);
                ...
                ctx.font = "24px 'Roboto', sans-serif";
                ctx.fillText('Click, Tap, or Press Space to Play Again', GAME_WIDTH / 2, GAME_HEIGHT / 2 + 60);
            }
        }
    ...
    return (
        <div className="flex flex-col items-center">
            <p className="text-lg text-gray-400 mb-4 text-center">A simple infinite runner. Click, tap, or press Space to jump over the obstacles!</p>
