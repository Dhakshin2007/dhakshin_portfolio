...
export const AnthropicLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 400 80" xmlns="http://www.w3.org/2000/svg">
    <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="bold" fontSize="40" fill="#1F1F1E"> {/* Using a dark grey for the text */}
      Anthropic
    </text>
  </svg>
);
