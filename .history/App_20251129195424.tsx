                    ...
                    <div className="relative z-10 max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-16 items-center">
                            ...
                            <div className="flex flex-col gap-6 items-center justify-center w-full">
                                ...
                                <div className={`glass-panel rounded-xl p-4 w-full h-[400px] flex items-center justify-center relative transition-all duration-500 ${skillsViewMode === 'list' ? 'items-start overflow-hidden' : ''}`}>
                                    {skillsViewMode === '3d' ? (
