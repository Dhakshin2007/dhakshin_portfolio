...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description: 'It is a simple programming language which is written in Python, it is a simple compiler which takes the input from the user and gives the output in English.',
        image: '',
