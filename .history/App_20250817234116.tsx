...
const App: React.FC = () => {
    ...
    useEffect(() => {
        const fetchVisitorCount = async () => {
            try {
                // Using a free counting API. Namespace/key should be unique to the site.
                const response = await fetch('https://api.countapi.xyz/hit/dhakshinkotha-portfolio/visits');
